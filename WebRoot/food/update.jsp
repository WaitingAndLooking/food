...
.btn {
	...
	<body>
		...
		<div align="center">
			...
			%>
			<div align="center">
				<form action="/meituanwaimai/foodaction!update.action" method="post"
					...
					<table height="450" width="500" border="0">
						<tbody>
							<tr>
								<td align="center">
									<font face="仿宋"> <font size="4"><strong>类型</strong>
									</font> </font>
								</td>
								<td align="center">
							...
							<%
								List<Type> list=(List<Type>)session.getAttribute("xgtname");
