										...
										<tr>
											<th>
												<table id="table-breakpoint27">
													...
													<s:iterator value="#session.list" var="o">
													
													<tr>
													<td><s:property value="#o.FName"/></td>
													<td><s:property value="#o.food.price"/></td>
													<td><s:property value="#o.restaurant.rname"/></td>
													<td><s:property value="#o.count"/></td>
													<td><s:property value="#o.allprice"/></td>
													<td>
													...
													<s:else>
														<a href="/meituanwaimai/orderaction!selectByStatus?o.oid=<s:property value='oid'/>">未送达</a>
													</s:else>
													
													</td>
													<td><a href="/meituanwaimai/orderaction!qddelete?o.oid=<s:property value='oid'/>">删除</a></td>
													</tr>
													</s:iterator>
													<tbody>	
