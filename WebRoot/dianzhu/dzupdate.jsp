...
<html>
	...
	<body>
		...
		<br />
		<div align="center">
			<s:form action="/resaction!dzupdate.action" method="post">
				<s:hidden name="aciton" value="update" />
				<s:textfield label="店名" cssStyle="height:35px; border-radius: 15px;width:270;" name="res.rname"
				...
				<s:textarea label="特色食品" cssStyle="height:35px; border-radius: 15px;width:270;" name="res.foods"
					value="%{#session.res.foods}"></s:textarea>
				<s:textarea label="店铺介绍" cssStyle="height:35px; border-radius: 15px;width:270;" name="res.comments"
				...
				<td>
					<s:reset value="返回" theme="simple" onclick="history.back();"></s:reset>
				</td>
